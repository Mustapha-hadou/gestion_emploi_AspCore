...
namespace miniPrpject_Asp.Controllers
{
    public class LocalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TypeLocal,Capacite,Nom,localisation")] Local local)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TypeLocal,Capacite,Nom,localisation")] Local local)
        {
            if (id != local.Id)
            {
                return NotFound();
